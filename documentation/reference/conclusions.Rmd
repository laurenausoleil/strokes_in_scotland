...
analysis_bydemographic/healthboard/diagnosis
  Slightly higher mortality from stroke in Shetland vs normal distribution of deaths per diagnosis.

# Council

Unable to explore incidence rates by council area.

analysis_bydemographic/council/mortality
  These adjusted mortality rates show that there is a difference in stroke mortality between different council areas. 
...
analysis_bydemographic/council/Council mortality rates over time for highest and lowest mortality rate councils/10 highest and lowest all time mortality rates, mean
  Greatest divergences in 2010 and 2015.
  Note that these are the years after the two government strategies published.
  
analysis_bydemographic/council/Council mortality rates over time for highest and lowest mortality rate councils/10 highest and lowest mortality councils in 2018, Mean 
...
analysis_bydemographic/council/Council mortality rates over time for highest and lowest mortality rate councils/10 highest and lowest all time mortality rates, Median
...
analysis_bysimd/discharges
  More hospital activity with higher deprivation.
  
analysis_bysimd/discharges over time
