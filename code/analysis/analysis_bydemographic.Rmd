...
```{r}
council_strokesbyca %>% 
# filter year to remove high values from years prior to 2013 in order to make graph mor readable
...
## Incidence per diagnosis

## Percent deaths per incidence by diagnosis.
